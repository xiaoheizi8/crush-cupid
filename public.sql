...
CREATE TABLE "public"."sys_user" (
  ...
  "created_at" timestamptz(6) DEFAULT now(),
  "updated_at" timestamptz(6) DEFAULT now(),
  "preferred_voice" varchar(64) COLLATE "pg_catalog"."default"
)
;
...
SELECT setval('"public"."crush_id_seq"', 4, true);
...
SELECT setval('"public"."sys_audit_log_id_seq"', 22, true);
...
SELECT setval('"public"."sys_email_code_id_seq"', 6, true);
...
SELECT setval('"public"."sys_quota_id_seq"', 3, true);
...
SELECT setval('"public"."sys_usage_daily_id_seq"', 7, true);
